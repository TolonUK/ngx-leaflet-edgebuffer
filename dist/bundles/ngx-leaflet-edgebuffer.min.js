...
this.edgeBufferOptions=null,this.leafletDirective=new n.LeafletDirectiveWrapper(e)}return e.prototype.ngOnInit=function(){this.leafletDirective.init();
...
/** @nocollapse */
e.ctorParameters=function(){return[{type:n.LeafletDirective}]},e.propDecorators={edgeBufferOptions:[{type:t.Input,args:["leafletEdgeBufferOptions"]}]},e}(),o=/** @class */function(){function e(){}return e.forRoot=function(){return{ngModule:e,providers:[]}},e.decorators=[{type:t.NgModule,args:[{exports:[f],declarations:[f]}]}],
/** @nocollapse */
